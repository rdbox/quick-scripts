...
#crawls the website and looks for vulnerable pages based on 500 HTTP error
#tweaked from a crawler script existent on the internet 
#Prajwal Panchmahalkar prajwal at Matriux dot com 
